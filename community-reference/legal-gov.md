...
## Civic Engagement
What does civic engagement mean to you? FindLaw has a [resource](https://www.findlaw.com/public/civic-engagement.html) that pulls together information that could help you be part of the solutions for issues affecting your community, highlighting that a healthy democracy requires active participation. 

There are all sorts of ways to be a part of those solutions: [register to vote and be an informed voter](https://kclibrary.org/community-services/voter-information), attend [city hall meetings](http://cityclerk.kcmo.org/LiveWeb/Meetings/CombinedAgenda.aspx), consider like-minded national organizations (such as [Partnership for a American Democracy](https://www.pfad.us/#page-section-608056b739c5cd3dffb59164), [Our Common Purpose](https://www.amacad.org/ourcommonpurpose/report), [Renew America Together](https://renewamericatogether.org/), [Citizen Connect](https://citizenconnect.us/) and many others), connect with local organizations like UMKC's [Center for Neighborhoods](https://cfn.umkc.edu/) and [Urban Neighborhood Initiative](https://uni-kc.org/), respond to [Kansas City Spirit Playbook](https://playbook.kcmo.gov/) surveys that will impact Kansas City for the next 20 years, and so much more.
